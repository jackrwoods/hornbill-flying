...
export default function BookLayout({
  ...
  return (
    <>
      ...
      {children}
      <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-on-immersive/20 bg-immersive-bg-night p-3 lg:hidden">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3">
          <PhoneLink
            className="text-sm text-on-immersive hover:text-immersive-accent"
            showIcon
          />
          <CTALink
            href="/book/"
