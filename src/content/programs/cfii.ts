...
export const cfiiProgram = {
  ...
  quickAnswer:
    "Hornbill Aviation offers Part 61 Certified Flight Instructor Instrument (CFII) training at Reno–Tahoe (RNO). You learn to teach instrument procedures in a PA28 fleet, prepare for the Flight Instructor Instrument ACS, and add instrument instruction privileges to your existing CFI certificate.",
  benefits: {
