...
export const instructorsFAQ: FAQItem[] = [
  {
    ...
    question: "Can I choose my instructor at Hornbill?",
    answer:
  ...
  },
  {
    ...
    answer:
      "We will match you with another Hornbill CFI who teaches the same programs. Every instructor trains in the same PA28 fleet, so your progress stays consistent.",
  },
];
