...
export function Prose({ children, className }: ProseProps) {
  return (
    <div
      className={cn(
        "mx-auto max-w-2xl",
        "[&_h2]:mt-12 [&_h2]:mb-4 [&_h2]:font-heading [&_h2]:text-3xl [&_h2]:leading-tight [&_h2]:text-heading",
        "[&_h3]:mt-8 [&_h3]:mb-3 [&_h3]:font-heading [&_h3]:text-2xl [&_h3]:leading-snug [&_h3]:text-heading",
        "[&_p]:mb-4 [&_p]:text-base/relaxed [&_p]:text-body",
        "[&_ul]:mb-6 [&_ul]:list-disc [&_ul]:pl-5",
        "[&_ol]:mb-6 [&_ol]:list-decimal [&_ol]:pl-5",
        "[&_li]:mb-2 [&_li]:text-body",
        "[&_a]:text-heading [&_a]:underline [&_a]:decoration-accent/50 hover:[&_a]:decoration-accent [&_a]:transition-colors",
