 ...
 * Flight CTA. Mobile and `prefers-reduced-motion` collapse the cinematic
 * timeline to a vertical card stack internally. The global Header and Footer
 * render via the root layout and are not touched here. See
